...
{
  protected override IIdCreationStrategy IdCreationStrategy { get; } = new FromAttributesIdCreationStrategy("LoaderAppDomain", new[] { TraceEventsConstants.LoaderAppDomainName });
}
...
{
  protected override IIdCreationStrategy IdCreationStrategy { get; } = new FromAttributesIdCreationStrategy("LoaderAssembly", new[] { TraceEventsConstants.LoaderAssemblyName });
}
...
{
  protected override IIdCreationStrategy IdCreationStrategy { get; } = new FromAttributesIdCreationStrategy("LoaderModule", new[] { TraceEventsConstants.LoaderILFileName });
}