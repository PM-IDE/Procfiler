...
let source () =
    seq {
        ...
        yield
            TestCaseData(
                "YieldEnumerator",
                [ "YieldEnumerator.Program+<<Main>g__EnumerateSomeNumbers|0_0>d..ctor"
        ...
        yield
            TestCaseData(
                "TaskTestProject1",
                [ "TaskTestProject1.Program+<>c__DisplayClass0_0..ctor"
        ...
        yield
            TestCaseData(
                "SimpleAsyncAwait",
                [ "ASYNC_SimpleAsyncAwait.Program+<<Main>g__Foo|0_1>d"
        ...
        yield
            TestCaseData(
                "NotSimpleAsyncAwait",
                [ "ASYNC_NotSimpleAsyncAwait.Program+<>c__DisplayClass0_0+<<Main>b__1>d"
        ...
        yield
            TestCaseData(
                ...
                [ "NotExistingAssemblyLoading.Program+<>c..cctor"
        ...
        yield
            TestCaseData(
                "FinalizableObject",
                [ "FinalizableObject.ClassWithFinalizer..ctor"
        ...
        yield
            TestCaseData(
                "FileWriteProject",
                [ "ASYNC_FileWriteProject.Program+<Main>d__0"
        ...
        yield
            TestCaseData(
                "FileAsyncOperations",
                [ "ASYNC_FileAsyncOperations.Program+<Main>d__0"
        ...
        yield
            TestCaseData(
                ...
                [ "ExceptionTryCatchFinallyWhen.Program.<Main>g__Throw|0_0"
        ...
        yield
            TestCaseData(
                ...
                [ "ASYNC_ExceptionTryCatchFinallyAsync.Program+<<Main>g__Print|0_2>d"
        ...
        yield
            TestCaseData(
                ...
                [ "ExceptionTryCatchFinally.Program..ctor"
...
let SplitByMethodsTest projectName (expectedMethods: List<string>) =
    let doTest tempDir =
        ...
        let fileNameProcessor (name: string) =
            let chars =
                name.ToLower().ToCharArray() |> Array.filter (fun c -> c >= 'a' && c <= 'z')
