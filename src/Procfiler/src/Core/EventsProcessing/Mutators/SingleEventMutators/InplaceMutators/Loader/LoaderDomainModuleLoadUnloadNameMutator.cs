...
{
  public override string EventClass => TraceEventsConstants.LoaderDomainModuleLoad;
...
{
  public override string EventClass => TraceEventsConstants.LoaderDomainModuleUnload;
